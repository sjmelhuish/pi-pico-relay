...
class Oled():
    ...
    _fbcross = framebuf.FrameBuffer(_cross, FB_WIDTH, FB_HEIGHT, framebuf.MONO_HLSB)
    _thru = bytearray(
    ...
    _fbinvalid = framebuf.FrameBuffer(_invalid, FB_WIDTH, FB_HEIGHT, framebuf.MONO_HLSB)
    ...
    def message(self, message:str):
        ...
        self._oled_backoff = 100 # This will prevent the next 100 graphical updates

    def update(self, relay_state):
